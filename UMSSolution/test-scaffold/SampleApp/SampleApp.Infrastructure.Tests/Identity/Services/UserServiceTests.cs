...
using SampleApp.Application.Dtos.TwoFactor;
...
using SampleApp.Infrastructure.Identity.Models;
using SampleApp.Infrastructure.Identity.Services;
using SampleApp.Infrastructure.Tests.Support;

namespace SampleApp.Infrastructure.Tests.Identity.Services;
...
public class UserServiceTests
{
    ...
    public async Task GetUsersPagedQueryAsync_ReturnsPaginatedResult()
    {
        ...
        var request = new SampleApp.Application.Dtos.Pagination.PagedFilterRequest
        {
            PageNumber = 1,
            PageSize = 5,
            SortBy = "email",
    ...
    public async Task ForgotPasswordAsync_WhenEmailServiceThrows_StillReturnsSafeSuccessResponse()
    {
        ...
        _emailService.Setup(e => e.SendAsync(It.IsAny<SampleApp.Application.Dtos.Email.SendEmailDto>(), It.IsAny<CancellationToken>()))
    ...
    public async Task ForgotPasswordAsync_WhenEmailSent_ReturnsSuccess()
    {
        ...
        _emailService.Verify(e => e.SendAsync(
            It.Is<SampleApp.Application.Dtos.Email.SendEmailDto>(dto => 
                dto.MailTo == "u@t.com" &&
    ...
    public async Task RegisterUserAsync_WhenAutoConfirmEmailTrue_DoesNotSendEmail()
    {
        ...
        result.IsSuccessful.Should().BeTrue();
        _emailService.Verify(e => e.SendAsync(It.IsAny<SampleApp.Application.Dtos.Email.SendEmailDto>(), It.IsAny<CancellationToken>()), Times.Never);
    }
    ...
    public async Task ResendConfirmationEmailAsync_WhenUnconfirmed_SendsEmailAndReturnsSuccess()
    {
        ...
        result.Messages.Should().ContainSingle().Which.Should().Be("If the email is registered, you will receive an email shortly.");
        _emailService.Verify(e => e.SendAsync(
            It.Is<SampleApp.Application.Dtos.Email.SendEmailDto>(dto => dto.MailTo == "u@t.com"),
            It.IsAny<CancellationToken>()), Times.Once);
    }
