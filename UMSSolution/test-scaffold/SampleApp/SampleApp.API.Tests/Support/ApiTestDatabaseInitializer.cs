...
using SampleApp.Infrastructure.Identity.Constants;
using SampleApp.Infrastructure.Identity.Models;
using SampleApp.Infrastructure.Persistence.Contexts;
    ...
    public static async Task InitializeAsync(IServiceProvider services)
    {
        ...
        catch (Exception ex)
        {
            throw new InvalidOperationException(
                "API test database setup failed. Ensure SQL Server is available for ConnectionStrings:TestConnection in SampleApp.API/appsettings.Testing.json.",
                ex);
        }
    }
